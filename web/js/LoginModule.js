...
class LoginModule{
    ...
    promise.then(response=> response.json())
       ...
       .catch( error =>{
           document.getElementById('infoLog').innerHTML = "Ошибка запроса (sendCredential): "+error
           document.getElementById('content').innerHTML = "";
       });
 }
    sendLogout(){
    ...
    registrationNewUser(){
     ...
     if(password1 !== password2){
         document.getElementById('infoLog').innerHTML = 'Пароли не совпадают';
         return;
     }
    ...
    promise.then(respnose => respnose.json())
        ...
        .catch(error =>{
            document.getElementById('infoLog').innerHTML = "Ошибка запроса (registrationNewUser): "+error;
            document.getElementById('content').innerHTML = "";
        });
 }
}
